...
<div class="navigation-menu">
    <div id ="navigation">
        ...
        <center>
        <div class="box">
       <div class="boxed"><h1 id="ab1" style="position: absolute; right:720px;"> Fahrenheight 451 
            ...
            <h3><img src="../img/Fahrenheit_451.jpg"width="250" height="350"></h3>
 
            </a>  
            <h5>By: Ray Bradbury</h5>
            <h5>Click here to purchase the book!</h5>
    
        
            
            <p style="margin-bottom: 0px;">Guy Montag is a fireman. His job is to destroy the most illegal of commodities, the printed book, along with the houses in which they are
                ...
                </div> <div class="level2"> <h6>Book 1 of 1<br> Cascades</h6> </div>
                </div> <div class="level3"> <h6>Print Length<br> 249 Pages</h6> </div>
                </div> <div class="level4"> <h6>Grade Level</h6><br>5+ </div>
